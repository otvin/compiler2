...
def main():
    ...
    dotest("tests/testbyref05.pas", "tests/testbyref05.out")
    ...
    dotest("tests/testfunctions15.pas", "tests/testfunctions15.out")
    ...
    do_compilefailtest("tests/compilefail20.pas", "tests/compilefail20.out")
    do_compilefailtest("tests/compilefail21.pas", "tests/compilefail21.out")
    do_compilefailtest("tests/compilefail22.pas", "tests/compilefail22.out")
    do_compilefailtest("tests/compilefail23.pas", "tests/compilefail23.out")
    do_compilefailtest("tests/compilefail24.pas", "tests/compilefail24.out")
    do_compilefailtest("tests/compilefail25.pas", "tests/compilefail25.out")
